...
namespace CaveStoryModdingFramework
{
    ...
    public static class BulletList
    {
        public static readonly ReadOnlyDictionary<int, BulletInfo> BulletInfos = new ReadOnlyDictionary<int, BulletInfo>(new Dictionary<int, BulletInfo>()
        {
            ...
            {16,new BulletInfo("Missile Launcher Lv. 1 (Explosion)", new Rectangle(0,0,0,0))},
            {17,new BulletInfo("Missile Launcher Lv. 2 (Explosion)", new Rectangle(0,0,0,0))},
            {18,new BulletInfo("Missile Launcher Lv. 3 (Explosion)", new Rectangle(0,0,0,0))},
            ...
            {22,new BulletInfo("Bubbler Lv. 3 (Spines)", new Rectangle(0,0,0,0))},
            {23,new BulletInfo("Blade Lv. 3 (Slashes) ", new Rectangle(0,0,0,0))},
            ...
            {31,new BulletInfo("Super Missile Launcher Lv. 1 (Explosion)", new Rectangle(0,0,0,0))},
            {32,new BulletInfo("Super Missile Launcher Lv. 2 (Explosion)", new Rectangle(0,0,0,0))},
            {33,new BulletInfo("Super Missile Launcher Lv. 3 (Explosion)", new Rectangle(0,0,0,0))},
            ...
            {37,new BulletInfo("Spur Lv. 1 (Head)", new Rectangle(0,0,0,0))},
            {38,new BulletInfo("Spur Lv. 2 (Head)", new Rectangle(0,0,0,0))},
            {39,new BulletInfo("Spur Lv. 3 (Head)", new Rectangle(0,0,0,0))},
            {40,new BulletInfo("Spur Lv. 1 (Trail)", new Rectangle(0,0,0,0))},
            {41,new BulletInfo("Spur Lv. 2 (Trail)", new Rectangle(0,0,0,0))},
            {42,new BulletInfo("Spur Lv. 3 (Trail)", new Rectangle(0,0,0,0))},
